(function (global, factory) {
  ...
  var defineProperties = Object.defineProperties;// # changed by wingwuyf
  ...
  ResetViewNavigationControl.prototype.resetView = function () {
    ...
    if (defined$3(this.terria.trackedEntity)) {
      ...
      if (this.terria.options.defaultResetView) {
        ...
        } else if (this.terria.options.defaultResetView && typeof this.terria.options.defaultResetView === 'function') {
          this.terria.options.defaultResetView();
        } else if (this.terria.options.defaultResetView && this.terria.options.defaultResetView instanceof Object) {
